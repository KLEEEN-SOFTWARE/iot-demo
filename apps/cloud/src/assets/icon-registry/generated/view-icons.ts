export default {
  // View Icon for Experience: Overview on Workflow: Site Map Details
  'ks-view-6MxSUSiehmRP9kh7u543zo': { path: './assets/icons/browser-gauge.svg', alt: 'View' },
  // View Icon for Experience: Sensors on Workflow: Site Map Details
  'ks-view-4QW2xvV3Vsfs1RDwBfmZ6Q': { path: './assets/icons/alarm-clock-1-alternate.svg', alt: 'Listing' },
  // View Icon for Experience: Nodes on Workflow: Site Map Details
  ...
  // View Icon for Experience: Site Map on Workflow: Site Map Report
