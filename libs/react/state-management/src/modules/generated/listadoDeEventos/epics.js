...
/**
 * Add
 * @desc Redux-Observable Epic which allows to add an entity in "listadoDeEventos" workflow.
 */
...
/**
 * Bulk Add
 * @desc Redux-Observable Epic which allows to add entities in bulk in "listadoDeEventos" workflow.
 */
...
/**
 * Delete
 * @desc Redux-Observable Epic which allows to delete an entity in "listadoDeEventos" workflow.
 */
...
/**
 * Bulk Delete
 * @desc Redux-Observable Epic which allows to delete entities in bulk in "listadoDeEventos" workflow.
 */
...
/**
 * Safe Delete
 * @desc Redux-Observable Epic which allows to safely delete entities in "listadoDeEventos" workflow.
 */
export function safeDelete(action$) {
  return action$.pipe(
    ofType(actions.safeDeleteRequest.type),
    mergeMap((action) =>
      BaseApiService.graphqlEntityCRUD('Event')
        .delete({
          id: action.payload && action.payload.id,
        })
        .pipe(
 ...
 * @desc Redux-Observable Epic which allows to dispatch a custom action in "listadoDeEventos" workflow.
 */
...
/**
 * Get
 * @desc Redux-Observable Epic which allows to get an entity in "listadoDeEventos" workflow.
 */
...
/**
 * Auto Complete
 * @desc Redux-Observable Epic which allows to auto-complete values in "listadoDeEventos" workflow.
 */
...
/**
 * Get Widget Data
 * @desc Redux-Observable Epic which allows to get the data for a widget in "listadoDeEventos" workflow.
 */
...
/**
 * Update
 * @desc Redux-Observable Epic which allows to update an entity in "listadoDeEventos" workflow.
 */
...
/**
 * Bulk Update
 * @desc Redux-Observable Epic which allows to update entities in bulk in "listadoDeEventos" workflow.
 */
