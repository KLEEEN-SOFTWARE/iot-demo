...
/**
 * Add
 * @desc Redux-Observable Epic which allows to add an entity in "nodes" workflow.
 */
...
/**
 * Bulk Add
 * @desc Redux-Observable Epic which allows to add entities in bulk in "nodes" workflow.
 */
...
/**
 * Delete
 * @desc Redux-Observable Epic which allows to delete an entity in "nodes" workflow.
 */
...
/**
 * Bulk Delete
 * @desc Redux-Observable Epic which allows to delete entities in bulk in "nodes" workflow.
 */
...
/**
 * Safe Delete
 * @desc Redux-Observable Epic which allows to safely delete entities in "nodes" workflow.
 */
 ...
 * @desc Redux-Observable Epic which allows to dispatch a custom action in "nodes" workflow.
 */
...
/**
 * Get
 * @desc Redux-Observable Epic which allows to get an entity in "nodes" workflow.
 */
...
/**
 * Auto Complete
 * @desc Redux-Observable Epic which allows to auto-complete values in "nodes" workflow.
 */
...
/**
 * Get Widget Data
 * @desc Redux-Observable Epic which allows to get the data for a widget in "nodes" workflow.
 */
...
/**
 * Update
 * @desc Redux-Observable Epic which allows to update an entity in "nodes" workflow.
 */
...
/**
 * Bulk Update
 * @desc Redux-Observable Epic which allows to update entities in bulk in "nodes" workflow.
 */
