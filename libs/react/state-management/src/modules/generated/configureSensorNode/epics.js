...
/**
 * Add
 * @desc Redux-Observable Epic which allows to add an entity in "configureSensorNode" workflow.
 */
...
/**
 * Bulk Add
 * @desc Redux-Observable Epic which allows to add entities in bulk in "configureSensorNode" workflow.
 */
...
/**
 * Delete
 * @desc Redux-Observable Epic which allows to delete an entity in "configureSensorNode" workflow.
 */
...
/**
 * Bulk Delete
 * @desc Redux-Observable Epic which allows to delete entities in bulk in "configureSensorNode" workflow.
 */
...
/**
 * Safe Delete
 * @desc Redux-Observable Epic which allows to safely delete entities in "configureSensorNode" workflow.
 */
export function safeDelete(action$) {
  return action$.pipe(
    ofType(actions.safeDeleteRequest.type),
    mergeMap((action) =>
      BaseApiService.graphqlEntityCRUD('configureSensorNode')
        .delete({
          id: action.payload && action.payload.id,
        })
        .pipe(
 ...
 * @desc Redux-Observable Epic which allows to dispatch a custom action in "configureSensorNode" workflow.
 */
...
/**
 * Get
 * @desc Redux-Observable Epic which allows to get an entity in "configureSensorNode" workflow.
 */
...
/**
 * Auto Complete
 * @desc Redux-Observable Epic which allows to auto-complete values in "configureSensorNode" workflow.
 */
...
/**
 * Get Widget Data
 * @desc Redux-Observable Epic which allows to get the data for a widget in "configureSensorNode" workflow.
 */
...
/**
 * Update
 * @desc Redux-Observable Epic which allows to update an entity in "configureSensorNode" workflow.
 */
...
/**
 * Bulk Update
 * @desc Redux-Observable Epic which allows to update entities in bulk in "configureSensorNode" workflow.
 */
