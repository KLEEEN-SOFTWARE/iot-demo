...
/**
 * Add
 * @desc Redux-Observable Epic which allows to add an entity in "siteMapDetails" workflow.
 */
...
/**
 * Bulk Add
 * @desc Redux-Observable Epic which allows to add entities in bulk in "siteMapDetails" workflow.
 */
...
/**
 * Delete
 * @desc Redux-Observable Epic which allows to delete an entity in "siteMapDetails" workflow.
 */
...
/**
 * Bulk Delete
 * @desc Redux-Observable Epic which allows to delete entities in bulk in "siteMapDetails" workflow.
 */
...
/**
 * Safe Delete
 * @desc Redux-Observable Epic which allows to safely delete entities in "siteMapDetails" workflow.
 */
 ...
 * @desc Redux-Observable Epic which allows to dispatch a custom action in "siteMapDetails" workflow.
 */
...
/**
 * Get
 * @desc Redux-Observable Epic which allows to get an entity in "siteMapDetails" workflow.
 */
...
/**
 * Auto Complete
 * @desc Redux-Observable Epic which allows to auto-complete values in "siteMapDetails" workflow.
 */
...
/**
 * Get Widget Data
 * @desc Redux-Observable Epic which allows to get the data for a widget in "siteMapDetails" workflow.
 */
...
/**
 * Update
 * @desc Redux-Observable Epic which allows to update an entity in "siteMapDetails" workflow.
 */
...
/**
 * Bulk Update
 * @desc Redux-Observable Epic which allows to update entities in bulk in "siteMapDetails" workflow.
 */
