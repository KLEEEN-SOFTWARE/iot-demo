...
/**
 * Add
 * @desc Redux-Observable Epic which allows to add an entity in "sites" workflow.
 */
...
/**
 * Bulk Add
 * @desc Redux-Observable Epic which allows to add entities in bulk in "sites" workflow.
 */
...
/**
 * Delete
 * @desc Redux-Observable Epic which allows to delete an entity in "sites" workflow.
 */
...
/**
 * Bulk Delete
 * @desc Redux-Observable Epic which allows to delete entities in bulk in "sites" workflow.
 */
...
/**
 * Safe Delete
 * @desc Redux-Observable Epic which allows to safely delete entities in "sites" workflow.
 */
 ...
 * @desc Redux-Observable Epic which allows to dispatch a custom action in "sites" workflow.
 */
...
/**
 * Get
 * @desc Redux-Observable Epic which allows to get an entity in "sites" workflow.
 */
...
/**
 * Auto Complete
 * @desc Redux-Observable Epic which allows to auto-complete values in "sites" workflow.
 */
...
/**
 * Get Widget Data
 * @desc Redux-Observable Epic which allows to get the data for a widget in "sites" workflow.
 */
...
/**
 * Update
 * @desc Redux-Observable Epic which allows to update an entity in "sites" workflow.
 */
...
/**
 * Bulk Update
 * @desc Redux-Observable Epic which allows to update entities in bulk in "sites" workflow.
 */
